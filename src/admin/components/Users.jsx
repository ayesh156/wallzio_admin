...
function Users() {
  ...
  return (
    <main className='p-5 grow bg-white my-2 mr-2 rounded-3xl'>
      <h1 className='text-primary2 text-xl font-bold mb-4'>Users</h1>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex justify-center items-center">
          <div className="md:w-[800px] w-[80vw] flex flex-col">
            ...
            <div className="bg-white p-2 rounded h-[80vh] overflow-y-scroll">
              <div className="p-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Add User</h3>
              ...
              {sortedData.map(item => (
                <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                  ...
                  <td className="px-6 py-4 flex items-center">
                    <button onClick={toggleModal2} className="text-gray-400 hover:text-gray-600 ease-out duration-1000">
                      Edit
                    </button>
      ...
      {isModal2Open && (
        <div className="fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex justify-center items-center">
          <div className="md:w-[800px] w-[80vw] flex flex-col">
            ...
            <div className="bg-white p-2 rounded h-[80vh] overflow-y-scroll">
              <div className="p-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Edit User</h3>
                <div className="space-y-3">
                  <div className="border-b border-gray-900/10 pb-4">
                ...
                <div className="mt-6 flex items-center justify-end gap-x-6">
                  <button type="button" className="text-sm font-semibold leading-6 text-gray-900" onClick={toggleModal2}>Cancel</button>
                  <button type="submit" className="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Save</button>
                </div>
              </div>
            </div>
